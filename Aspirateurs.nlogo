...
to Go
  if not any? nodes with [color = blue] [stop]
...
to clean-node
  ask nodes in-radius 0 [set color green]
  ask nodes in-radius 0 [set Ncleaning Ncleaning + 1]
end


  ;let target [one-of link-neighbors] of nodes in-radius 0

;move-to one-of nodes in-radius 0

;[ n-of 1 link-neighbors ]

;ask nodes in-radius 0 [ask link-neighbors [set color green] ]
